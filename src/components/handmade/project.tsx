...
export function Project(props: {
  ...
  return (
    <div style={shadow} className="border-1 border-uchicago-red rounded-xl flex flex-col md:flex-row md:mx-30 mx-5 my-10 p-10 overflow-clip">
      <div className="md:w-[30%]">
              <img className="object-contain"
        src={props.image}
        alt={props.image_alt}
      />
      <div className="font-light text-center">{props.image_description}</div>
      </div>
